...
(function() {
  const ECOSYSTEM_INDEX = [
    ...
    { title: "Global Agri-Subsidy & Grant Navigator (CA/USDA/EU/KR)", cat: "tool", url: "tools/global-agri-subsidy-grant-navigator.html", icon: "🌐", desc: "California CDFA (SWEEP/HSP/AMMP/FPIP), USDA EQIP/REAP, EU BLE, and Korea smart farm subsidies with 7-point verified dossiers and grant ROI modeling", tags: "subsidy grant sweep cdfa hsp ammp fpip reap eqip ble smartfarm funding incentive 보조금 지원금 california" },
    { title: "Master 35 Enterprise Tools Suite Directory", cat: "tool", url: "tools/index.html", icon: "🛠️", desc: "Full catalog of 35 industrial-grade CEA simulators and calculation engines", tags: "all tools directory index calculators suite" },
